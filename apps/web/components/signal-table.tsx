...
type Signal = { id: number; symbol: string; direction: "LONG" | "SHORT"; score: number; tier?: "BASE" | "A_PLUS"; reasons?: string[]; entry: string; stopLoss: string; tp1: string; tp2: string; tp3: string; riskUsd: number; timeframe: string; status: string; receivedAt: string };
