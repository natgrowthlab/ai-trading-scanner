...
export default function BinancePage() {
  ...
  return <main className="binance-page">
    <div className="scanner-heading"><div><p className="eyebrow">LIVE CRYPTO FUTURES DATA</p><h1>Binance Futures</h1><p className="lead">Contratos perpetuos USDT‑M reales, actualizados cada cinco segundos. El panel analiza mercado y no tiene permisos para ejecutar órdenes.</p></div><p className="live-badge"><span /> LIVE / USDT‑M</p></div>
